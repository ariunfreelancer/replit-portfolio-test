          ...
          >
            ...
            <div className="relative z-10">
              ...
              <p className="text-muted-foreground mb-8 text-lg">
                I'm currently accepting new freelance opportunities and
                consulting roles.
              </p>
              ...
              <div className="space-y-4">
                ...
                >
                  <div>
                    <p className="text-sm text-[#14a800]/80 mb-1">
                      Hire me on Upwork
                    </p>
                    <p className="text-lg font-medium text-[#14a800]">
